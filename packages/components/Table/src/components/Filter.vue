<template>
  <div class="ta-basic-table-filter flex align-center" :data-filter-params="tableFilterParams">
    ...
    <Button
      ...
      type="primary"
      prevIcon="ant-design:filter-outlined"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      let defaultInputFormSchema: FormSchema = {
        field: "searchValue",
        label: "",
      ...
      let pannelFormSchema = props.forms?.pannelForm ?? [];
      ...
      async function handlePannelFormSubmit(values: Recordable) {
...
<style lang="less" scoped>
  @import "../../index.less";
  @prefix-cls: ~"@{namespace}-basic-table-filter";

  .@{prefix-cls} {
    flex: 1 1 50%;

    :deep(.filter-input-form) {
      width: 380px;
      margin-right: @gapy;
    ...
    :deep(.filter-pannel-form-modal-activator) {
      .ant-badge {
        position: absolute;
        top: -15px;
        right: -80%;
